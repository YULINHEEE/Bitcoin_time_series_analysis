...
# Fit models using both ML and CSS methods
model_results = fit_arima_models(bitcoin_log_diff, final_candidates)

# ================================
# Model Comparison and Selection
# ================================

def compare_models(results, criterion='aic'):
...
if SAVE_RESULTS:
    ...
    with open('model_fitting_results.pkl', 'wb') as f:
